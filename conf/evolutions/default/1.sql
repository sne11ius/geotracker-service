...
create table `namedlocations` (`id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,`userId` VARCHAR(254) NOT NULL,`name` VARCHAR(254) NOT NULL,`latitude` DOUBLE NOT NULL,`longitude` DOUBLE NOT NULL,`radius` REAL NOT NULL);
